...
class RetinaNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.anchor_generator = anchor_generator = _default_anchorgen()
        self.head = RetinaNetHead(backbone.out_channels, anchor_generator.num_anchors_per_location()[0],
                                  num_classes, norm_layer=partial(nn.GroupNorm, 32),)
    ...
    def generate_detection(self, features, head_outputs, anchors, images, original_image_sizes):
    ...
    def forward(self, images, targets=None):
        ...
        if self.training:
            ...
            if self.ssl_mode:
                detections = self.generate_detection(features, head_outputs, anchors, images, original_image_sizes)
...
def retinanet_resnet50_fpn_v2(num_classes, **kwargs: Any,) -> RetinaNet:
    backbone = resnet50(weights=None)
    backbone = _resnet_fpn_extractor(backbone, 5, returned_layers=[2, 3, 4], extra_blocks=LastLevelP6P7(2048, 256))
